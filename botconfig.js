module.exports = {
  ...
  Token: process.env.Token || "MTAzNTY3MzUxMzY2NDcwODYzOQ.GAgDk2.L3-FwCgzmrP29FETmDAjCJF8TQY8WHsuhq8Dh4", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1035673513664708639", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "g4pk1HG9h3MB_Q9OkCIPEHwvEDb4S1IB", // Discord Client Secret
  ...
  Presence: {
    ...
    type: "BATUKADA", // PLAYING, WATCHING, LISTENING, STREAMING
  },
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "e1b1c9c450574fa499d4198ff80b1ec6", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "c767f2be15df46adabfe5fe03f1f4e16", // Spotify Client Secret
  },
};
